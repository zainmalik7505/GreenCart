    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                LineSecureField( title: "Password", placholder: "Enter your password", txt: $viewModel.password, isShowPassword: $loginVM.isShowPassword)
                ...
                NavigationLink(destination: MainTabView(), isActive: $isMainView) {
                    EmptyView()
                }
